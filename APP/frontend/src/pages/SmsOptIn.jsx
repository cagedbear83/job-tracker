          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              {[
                ...
                <div
                  key={label}
                  className="border border-zinc-200 p-4 text-center"
                >
                  <Icon
                    size={20}
                    weight="bold"
                    className="text-[#0033A0] mx-auto mb-2"
                  />
            ...
            <div className="border border-[#0033A0] bg-[#f0f4ff] p-5 mb-6">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-zinc-800 leading-relaxed">
                  ...
                  <Link to="/privacy" className="text-[#0033A0] underline">
                    Privacy Policy
                  </Link>{" "}
                  and{" "}
                  <Link to="/terms" className="text-[#0033A0] underline">
                    Terms & Conditions
                  </Link>
                  .
                </span>
